...
return <div>
    ...
    <div className="container-wrapper grid grid-cols-1 xl:grid-cols-[2fr,1fr]  gap-4 ">
        ...
        <div className="justify-end flex flex-col gap-2 md:justify-center ">
            <div className="">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[2fr,1fr]">
                ...
                <div className="border p-3 rounded-md bg-white">
                    <div>
                        ...
                        <div className="mt-5">
                            <p className="rounded-full bg-yellow-400 w-[120px] px-[12px] text-[10px] font-bold m-auto">
                                ₹
                                EMI
                                AVAIABLE</p>
                            <div className="flex justify-between align-middle bg-orange-200 py-6 px-2 rounded-md  ">
                                <div>
                                    <p className="text-[14px] font-bold mb-2">From ₹2,0399/month</p>
                                    <p className="text-[12px]">No Cost EMI also a available</p>
                                </div>
                                <div>
                                    <p className="text-[14px] font-bold underline text-blue-900">View Plan</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex justify-between mt-2">
    ...
    <div className="bg-white py-3 shadow-md">
        <div className="container-wrapper gap-12 flex justity-start">
            <div>
                <p className="text-md">Itinerary</p>
            </div>
            <div>
                <p className="text-md">Tour Details</p>
            </div>
            <div>
                <p className="text-md">Tour Information</p>
            </div>
            <div>
                <p className="text-md">Need to Know</p>
            </div>
            <div>
                <p className="text-md">Policy & Terms</p>
            </div>
            <div>
                <p className="text-md">Itinerary</p>
            </div>
    ...
    <div className="container-wrapper  grid grid-cols-1 xl:grid-cols-[2fr,1fr]">
        <div>
            ...
            <div className="flex justify-between my-5">
                <p className="text-[22px] font-semibold">Itinerary <span
                        className="text-[13px] italic text-slate-600 ">(Day
                        Wise)</span></p>
            ...
            <div className={`pl-14 border-l ml-4 border-dashed pb-10 pt-5 ${isItinerary?"block":"hidden"}`}>
                ...
                {/* 2 Time Multiple */}
                <div className='bg-slate-100 rounded-md p-5 w-[520px] my-5' >
            ...
            <div>
                ...
                <div className="flex justify-between mt-5 gap-2 border-b-2 border-indigo-900">
                    <div onClick={() => handleTabClick('tab1')} className={`cursor-pointer rounded-t-lg py-2 px-10 bg-indigo-900 grow text-center text-[16px]  text-white ${activeTab === 'tab1' ? 'bg-indigo-900' : 'border-x-[1px] border-t-[1px] border-indigo-900 text-black bg-slate-200'}`}>
                        <p>Flight Details </p>
                    </div>
                    <div onClick={() => handleTabClick('tab2')} className={`cursor-pointer rounded-t-lg py-2 px-10 bg-indigo-900 grow text-center text-[16px]  text-white ${activeTab === 'tab2' ? 'bg-indigo-900' : 'border-x-[1px] border-t-[1px] border-indigo-900 text-black bg-slate-200'}`}>
                        <p>Flight Details </p>
                    </div>
                    <div onClick={() => handleTabClick('tab3')} className={`cursor-pointer rounded-t-lg py-2 px-10 bg-indigo-900 grow text-center text-[16px]  text-white ${activeTab === 'tab3' ? 'bg-indigo-900' : 'border-x-[1px] border-t-[1px] border-indigo-900 text-black bg-slate-200'}`}>
                        <p>Flight Details </p>
                    </div>
                ...
                <div className="border rounded-b-lg  overflow-hidden">
                    ...
                    <div className={`p-5 list-disc ml-[20px] ${activeTab === 'tab2' ? 'block' : 'hidden'}`}>
                        <div className=''>
                    ...
                    <div className={` ${activeTab === 'tab3' ? 'block' : 'hidden'}`}>
                        <div className='grid grid-cols-[0.9fr,,2fr] border-b-2'>
                            <div className=' bg-slate-100 pl-10  pt-3 pb-2 '>
            ...
            <div>
                ...
                <div className="lg:block max-[600px]:flex">
                ...
                <div>
                    ...
                    <div className="flex justify-between mt-5 gap-2 border-b-2 border-indigo-900">
                        <div onClick={()=>{UpgradesAvalilableTabClick("tab1")}} className={`cursor-pointer rounded-t-lg py-2 px-10 bg-indigo-900 grow text-center text-[16px]  text-white ${UpgradesAvalilable === 'tab1' ? 'bg-indigo-900' : 'border-x-[1px] border-t-[1px] border-indigo-900 text-black bg-slate-200'}`}>
                            <p>Flight Details </p>
                        </div>
                        <div onClick={()=>{UpgradesAvalilableTabClick("tab2")}}  className={`cursor-pointer rounded-t-lg py-2 px-10 bg-indigo-900 grow text-center text-[16px]  text-white ${UpgradesAvalilable === 'tab2' ? 'bg-indigo-900' : 'border-x-[1px] border-t-[1px] border-indigo-900 text-black bg-slate-200'}`}>
                            <p>Flight Details </p>
                        </div>
        ...
        <div className="mt-10">
            ...
            {/* card is here */}
            <div className="relative flex-shrink-0 max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg ml-[40px]">
            <div
